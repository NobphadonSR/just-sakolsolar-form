...
class SolarDatas(models.Model):
    ...
    preferred_contact_time = models.TimeField(null=True, blank=True, verbose_name='ช่วงเวลาที่สะดวกในการติดตั้ง')
    preferred_survey_date = models.DateField(null=True, blank=True, verbose_name='วันที่สะดวกในการสำรวจหน้างาน')
